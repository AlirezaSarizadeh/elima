...
export default function BlogCard({ post }: { post: BlogPost }) {
  return (
    <Link
      href={`/blog/${post.slug}`}
      className="group bg-white rounded-3xl border border-gray-200 overflow-hidden hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-300 flex flex-col h-full"
    >
      {/* تصویر */}
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        {/* دکمه ادامه مطلب (صرفاً استایل، خود کارت لینک است) */}
        <div className="flex items-center gap-2 text-blue-600 font-bold text-sm mt-auto group/btn">
