        ...
        <div className="min-h-screen bg-gray-50 pb-20" dir="rtl">
            ...
            <header className="bg-white border-b border-gray-100/80">
                <div className="container mx-auto max-w-7xl px-4 py-6 md:py-8">
                    ...
                    {/* ردیف بالا: دسته‌بندی + متای کوتاه */}
                    <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                        <div className="flex flex-wrap items-center gap-2 text-[11px] md:text-xs">
                            ...
                            <span className="bg-gray-50 text-gray-600 border border-gray-200 px-3 py-1 rounded-full font-medium">
                                استانبول
                            </span>
                        </div>

                        {/* متای خلاصه سمت چپ (روی موبایل هم تمیزه) */}
                        <div className="flex items-center gap-3 text-[11px] md:text-xs text-gray-400">
                            <div className="flex items-center gap-1">
                                <CalendarMonth sx={{ fontSize: 16 }} />
                                <span>۱۵ مهر ۱۴۰۳</span>
                            </div>
                            <span className="w-[1px] h-4 bg-gray-200 hidden sm:inline-block" />
                            <div className="flex items-center gap-1">
                    ...
                    {/* عنوان مقاله */}
                    <h1 className="text-[20px] md:text-2xl lg:text-3xl font-extrabold text-gray-900 leading-relaxed md:leading-snug tracking-tight">
                        ۱۰ نکته طلایی برای سفر ارزان به استانبول که آژانس‌ها به شما نمی‌گویند
                    </h1>

                    {/* خط اکسن ظریف زیر عنوان */}
                    <div className="mt-3 mb-4">
                        <div className="h-[2px] w-20 rounded-full bg-gradient-to-l from-blue-600 via-sky-500 to-sky-300" />
                    </div>

                    {/* نویسنده و جزئیات تکمیلی */}
                    <div className="flex flex-wrap items-center gap-4 text-[11px] md:text-sm text-gray-500">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium">سارا امینی</span>
                        </div>

                        {/* جداکننده نقطه‌ای کوچیک */}
                        <span className="w-1 h-1 rounded-full bg-gray-300" />

                        {/* روی دسکتاپ تکرار نمی‌کنیم، اما اگر خواستی می‌تونی اینجا چیز دیگری اضافه کنی */}
                        <span className="text-gray-400 text-[11px] md:text-xs">
                            نکات کاربردی برای سفر ارزان و هوشمندانه به استانبول
                        </span>
                    </div>
                </div>
            </header>
